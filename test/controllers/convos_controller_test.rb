...
class ConvosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create convo" do
    assert_difference('Convo.count') do
      post convos_url, params: { convo: { convo_id: @convo.convo_id, description: @convo.description, likes: @convo.likes, rume_id: @convo.rume_id, title: @convo.title, url: @convo.url, user_id: @convo.user_id } }
    end
  ...
  test "should update convo" do
    patch convo_url(@convo), params: { convo: { convo_id: @convo.convo_id, description: @convo.description, likes: @convo.likes, rume_id: @convo.rume_id, title: @convo.title, url: @convo.url, user_id: @convo.user_id } }
